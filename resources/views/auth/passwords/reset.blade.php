                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-9 col py-3">
                                <form method="POST" action="{{ url('reset-password') }}" >
                                    ...
                                    <div class="form-group last mb-3{{ $errors->has('password') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group last mb-3{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                                        <input type="password" class="form-control"  placeholder="Re-Password" name="password_confirmation" required autofocus>
                                        @if ($errors->has('password'))
                                            <span class="help-block">
                                                <strong style="font-size: 12px;color:red">{{ $errors->first('password_confirmation') }}</strong>
                                            </span>
                                        @endif
                                    </div>
                                    <div class="align-items-center">
                                    <button type="submit" class="btn btn-block btn-primary" style="height: 40px !important;margin-top:20px"> {{ __('Reset Password') }}</button>
                                    </div>
